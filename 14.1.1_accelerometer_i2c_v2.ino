...
void setup() {
 ...
 // when you need to calibrate the gravity acceleration, you can set the offset here and
//eliminate the note
...
void loop() {
 ...
 Serial.println(gz);
 // converted acceleration unit to g and the gyroscope unit to dps (degree per second)
